"""
Django settings for codeutsav project.
...
SECRET_KEY = '^q@ig+#67+)4xf3wz4sd+==m_9e-8knd1%h^-eedmbua(waf3v'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['192.168.225.44']
...
WSGI_APPLICATION = 'codeutsav.wsgi.application'
